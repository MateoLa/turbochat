class Message < ApplicationRecord
  ...
  # If message has attachments, broadcasting to the channel when uploading files makes ActiveStorage fail and none file is uploaded to the storage.
  # That is why we use broadcast_append_later_to and not broadcast_append_to but in this case messages are not added to the chat.
